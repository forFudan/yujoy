...
| 大碼 | 字根                                                                                       |
| :--- | :----------------------------------------------------------------------------------------- |
| A    | 丆h 厂h 石s 不u 瓦w 甫f 止i 龰i 齒c 足z 母m 彑m 㔾j 卩j                                    |
| B    | 皮p 又(癶スマ)o コk 马m 尸i 弓g 韋w 申s 由y 电d 黽m 車(叀)j 丰f                            |
| C    | 至z 高g 亠t 户(戸)h 衤i 𧘇i 女n 九j                                                         |
| D    | 囗w 白b 臼j 甶f 鬼g 𠂤d 戶h 鳥n 烏w 向x 舟z 門m 鬥d 片p 爿q 彳c 彡s 儿e 凵k 丩(丱)j 屮c 丂k |
| E    | 乚i 亻r 隹h 巳s 巴b 己j 已i 面m 而e 瓜g 爪z 乃n 廴y                                        |
| F    | 扌s 手(龵)s 一i 鸟n 乌w 尤o 尢o                                                            |
| G    | 竹z 气q 丿p 豸z 豕s 辛x 立l 十i                                                            |
| H    | 士s 土(耂)t 龶s 壴z 走z 冖m 欠q 饣s 夕x 鱼v 文e 亦i 亥h 方f 亡w                            |
| I    | 犬(犭)q 工g 二(⺀冫)e 自z 身s 宀b 穴x {左上}z                                               |
...
| O    | 小x 大d 夫f 𡗗p 之z 辶c 糸s 钅j                                                             |
| P    | 山s 巾j 卜b 虎h 鹵l 皿m 罒w 長c 镸c 髟b 阝f {鼠下}s                                        |
| Q    | 羊y 米m 丷(䒑リ)k 丬q 火h 灬b                                                              |
| R    | 人e 合h 僉q 斤j ⺁i 心i 忄i 馬m                                                             |
| S    | 艹(龷)o 卅(卌)s 革g 世i 用y 力l 乂(𠂭)i                                                     |
| T    | 乙i 飛f 攵p 金j 讠y 夊p                                                                    |
| U    | 木m 來l 上(丄)s 丨(〣〢)g 非f 其q 业e 匕b 长c 入r {亞下}a                                  |
| V    | 习x 彐(肀)x 丑o 田t 甲j 里l 禺y 魚v 虫c 黑h 尚(龸)s                                        |
| W    | 目m 且q 貝b 見j 月y 勹(⺆)b                                                                 |
| X    | 骨g 咼(冎)k 七i 车j 门m 言y 丁d 下(丅)x                                                    |
| Y    | 西(襾)x 酉y 见j 贝b 冂j 冊c 雨v 干g 牛(⺧)n 生s                                             |

### 小码记忆

卿雲方案使用强音托，字根小码 90% 以上情况下都是汉语拼音的第一个字母，其它则是拼音韵母。故而大部分的字根小码不用特别记忆，可以直接猜出来。

由于很多字根拼音只有两个字母，首字母容易被占用，故而 10% 情况下会选取其后续字母（主元音）作为音托。只要特别记住以下字根即可：
...
| i     | 矢世十尸 (shi)　止 (zhi)          |
| u     | 不                                |
| i　ㄧ | 一⺁乚乙已乂弋亦衤𧘇 (yi)　七　心忄 | 所有的 yi 都是i            |
| v　ㄣ | 雨鱼魚鱼予曰 (yu)                 | 所有的yu 都是v，除了「禺」 |

「麻」字根虽然没有使用声母音托，但大小码刚好等于其拼音。

「口」是使用频率最高的字根，所以它们的小码是 v。
