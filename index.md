...
输入法对比
C:\Users\zhuyu\AppData\Local\Temp\ipykernel_33296\607165388.py:56: FutureWarning: The provided callable <built-in function sum> is currently using DataFrameGroupBy.sum. In a future version of pandas, the provided callable will be used directly. To keep current behavior pass the string "sum" instead.
  .agg(sum)
C:\Users\zhuyu\AppData\Local\Temp\ipykernel_33296\3344339712.py:10: DtypeWarning: Columns (3) have mixed types. Specify dtype option on import or set low_memory=False.
  cjk = pd.read_csv("analysis/yuhao_division_golden_source.csv")
length of cjk-h 97046
length of cjk-i 97668
gb2312 6764 guozi 4808 gbk 21003 tonggui 6500 personal 125
jianti 6500 fanti 4933 fanjian 8396
蟶繳閆麪侷噁蹌戩滷鈺謔蹟翀廡歎僞鎚鋭皁殞卽瑋螄贇鉢攢朶鹵薈圇曇儕跥熒駡嬈檯燼説玅爲佈衊闕勳紈縐曬綉絝衹巘繮啓糉旣薦覷牀痠竈瓚頽〇㑚癡孃覈齶轆剮産唄誒樑喫襬裏嬡蓽飆刴噠曁衆濕躱廏顴顔鉅㞞纔餚閲崗躥昇摻崟躋奬諏槪饋淩鶩暘鵰淼箇摳癟擡伲讞㨃絶屌壎斕龕揹裋艶
char	code
--------------------
简体重码率：
1000 0
...
| code                      | char           |
| ------------------------- | -------------- |
| 形码方案                  | 简体选重率     | 繁体选重率     | 繁简混合选重率         | GB2312     | 国字常用     | GBK     | CJK-B     | CJK-D     | CJK-F     | CJK-H     | CJK-I     |
| :------------------------ | :------------- | :------------- | :--------------------- | :--------- | :----------- | :------ | :-------- | :-------- | :-------- | :-------- | :-------- |
