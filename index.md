...
**卿雲爛兮**是[**宇浩输入法**](http://zhuyuhao.com/yuhao/)的衍生方案，全乱序、强音托，两根字无补码。规则共两条：
...
以下为字根图，因为强音托，故而除了以下两类字根外，**不**标注小码。
...
本方案大码**乱序**，200多个字根的在25键上随机出现，优缺点都十分突出。故总结如下：
...
- 字形相近的部首在键盘上离散。因此，首根大码中可以包含更多信息，从而不需要回取首根小码用以识别，降低规则复杂度。
- 小码取音托的情况下，大码随机，有利于分散双手互击，提高理论击键速度。
- 同等条件下，小码的选取可以更加自由。故而本方案小码除了「口」字根外，严格选取其汉语拼音第一读音。
- 随是双编方案，但记忆量只限于大码，等效于乱序单编方案。
