...
卿雲爛兮是[宇浩输入法](http://zhuyuhao.com/yuhao/)的**乱序单编**衍生方案。取码规则共两条：
...
本方案的补码，是末根的读音首字母，唯一的例外是高频「口」字根：

| 末根补码 | 规则                                      | 举例                        |
| :------- | :---------------------------------------- | --------------------------- |
| v        | 所有拼音为 yu，即读音为 ㄣ 的，补码都取 v | 雨鱼魚鱼禺予 月曰 等        |
| i        | 所有拼音为 y，即读音为 ㄧ 的，补码都取 i  | 一⺁乚乙已乂弋亦衤𧘇言羊用 等 |
| v        | 使用频率最高的字根是v                     | 口                          |
