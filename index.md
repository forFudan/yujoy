...
{: .warning }
本方案为宇浩拆分25键大码乱序方案，初始学习难度较大（等效于200字根乱序单编方案），请务必充分了解、分析、平衡其风险和收益后再决定是否学习使用。

## 简介

**卿雲爛兮**是[**宇浩输入法**](http://zhuyuhao.com/yuhao/)的衍生方案，全乱序、强音托。着重优化不加识别码（首根小码）情况下的动态重码。关键数据如下：
...
卿雲方案使用强音托，字根小码 99% 以上情况下都是汉语拼音的第一个字母（有两个规则映射 yu -> v, y -> i），唯一的例外是高频「口」字根。因此小码不需要特别记忆。

| 小码 | 规则                                         | 举例                   |
| :--- | :------------------------------------------- | ---------------------- |
| v    | 所有拼音为 yu，即起始读音为 ㄣ 的，小码都是v | 雨鱼魚鱼禺予曰月       |
| i    | 所有拼音为 y，即起始读音为 ㄧ 的，小码都是i  | 一⺁乚乙已乂弋亦衤𧘇言羊 |
| v    | 使用频率最高的字根小码是v                    | 口                     |

以下为字根表，因为强音托，故而除了以下两类字根外，**不**标注小码。
...
| 大碼 | 字根                                                       |
| :--- | :--------------------------------------------------------- |
| A    | 木 甲 二(冫⺀) 干 キ(ヰ)k 用 韋                             |
| B    | 马 舌 忄 囗w 匕                                            |
| C    | 下(丅) 丁 示 乃 讠 长 自 來 馬 示 咼(冎)k                  |
| D    | 白 艹(龷) 卅(卌) 又(スマ癶) 厶 丂 至 高 见                 |
| E    | 亻 也 乜 門 鬥 㔾(卩)j コ 皮 文 儿 七 里 {亞下}i           |
| F    | 川 巛(巜)c 九 一 扌 贝 非                                  |
| G    | 廴i 禾 乂(𠂭)i 毛 竹 车 丌 見 尚(龸)                        |
| H    | 土(耂) 士 龶 鹿 穴 夭 欠 寸 走 骨                          |
| I    | 艮 丶(乀) 方 宀 勹b 臼 气 入 {爲下}w 虫 申 小              |
| J    | 日 曰 早 刀 弓 幺 辛 卯 千 臣 甫 貝 鹵 山                  |
| K    | 口(〇)v 手(龵) 豕s 而 面 丑 戈 弋 戊 习 之                 |
| L    | 丨 了 子 予 酉 西 丷(リ䒑) 疒b 缶 耳 世 辰 {鼠下}s {畏下}w |
| M    | 火 灬b 長 镸 髟 羊 鬼(甶) 壬 矢 大 𡗗 夫                    |
| N    | 氵(⺍) 心 不 工 瓦 齒 水 止(龰)                             |
| O    | 上(丄) 巳 巴 乙 飛 纟 丬 隹c 冖 魚 向 舟 亍 古 兀 刂 且    |
| P    | 八 牛(⺧) 生 革 冊 亡 阝 豸 斤(⺁)                           |
| Q    | 屮 丩(丱)j 凵k 冂 尤(尢) 犬(犭) 鳥 烏 母 彑j 户(戸) 丰 石  |
| R    | 亠 言 亥 门 其 十 巾                                       |
| S    | 几 殳 風 合 僉 衤 𧘇 力 雨 目 田                            |
| T    | 乚i 匚 片 爿 鱼 米 夊p 金 尸 虎                            |
| U    | 人 身 由 卜 广 糸 辶 饣                                    |
| V    | 丆 厂 瓜 爪 钅 彐(肀)j 麻 食 壴 业 禺                      |
| W    | 丿 彳 彡 𠂤 戶 末 未 己 已 女 立                            |
| X    | 皿 罒 黑 鸟 乌 車(叀) 牙 足 {左上}                         |
| Y    | 月 夕 电 黽m 亦 三 王                                      |
...
本方案大码**乱序**，200多个字根的在25键上随机出现，相比「光華」「星陳」，有以下缺点：

- 初始学习难度较大，同大键字根之间的字形关系不强，难以进行相似字形联想记忆。
- 后期维护成本较高，长时间不用容易遗忘。
...
- 相似字形的部首在键盘上离散。因此，首根大码中可以包含更多信息，从而不需要回取首根小码用以识别，降低规则复杂度。例如： 「⺌尚」字形相近，如果在同一个大键上，则「尘堂」两字若要分离，必须回取首根小码作为补码。
- 小码取音托的情况下，大码随机，有利于分散双手互击，提高理论击键速度。
- 同等条件下，小码的选取可以更加自由。故而本方案小码除了「口」字根外，严格选取其汉语拼音第一读音。因此，记忆量只限于大码，等效于乱序单编方案。
...
| 卿雲     | 8.0‱       | 8.0‱       | 13.5‱              | 554    | 188      | 6126 | 36917 | 39930 | 49422 | 56359 | 56861 |
...
| 卿雲     | 8.0‱       | 7.9‱       | 13.5‱              | 549    |      184 | 6110 | 36888 | 39901 | 49391 | 56327 | 56830 |
...
| 卿雲     | 2.7‱           | 7.7‱         | 4.7‱           | 5.5‱           | 25.4‱    | 8.6‱       | 4.9‱         | 9.8‱             | 23.9‱            | 12.4‱              |
...
| :-------------- | :----- | :------------- | :----------- | :------------- | :------------- | :------- | :--------- | :----------- | :------------- | :------------- | :--------------- |
| 卿雲·26键       | 46.38% | 47.49%         | 48.07%       | 47.31%         | 47.91%         | 44.31%   | 45.17%     | 46.83%       | 46.87%         | 44.23%         | 45.67%           |
